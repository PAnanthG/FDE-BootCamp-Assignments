...
Student: praveen  ·  Base URL: https://momentsearch-fde3.fly.dev

| Check | Result | Evidence |
|---|---|---|
| app_up | ✅ pass | GET / -> 200 |
| documents_async | ✅ pass | POST /admin/documents -> 202 in 154ms |
...
| cross_source | ✅ pass | kinds across answers: ['paper', 'video'] |
