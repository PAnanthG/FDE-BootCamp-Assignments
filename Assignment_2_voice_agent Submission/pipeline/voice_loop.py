...
goes. Provider is chosen in .env; see providers.py.
...
def speak(provider: Provider, text: str, locale: str | None = None) -> None:
...
def run(text_mode: bool) -> None:
    ...
    speak(provider, "Thanks for calling. This is Aurora — how can I help with your reservation?")
