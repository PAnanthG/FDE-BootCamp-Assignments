...
Uses OpenAI-style function calling, so this file only talks to Provider.chat().
"""
...
SYSTEM_PROMPT = """You are Aurora, a friendly phone reservations agent.
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "guests": {
                        "type": "string",
                        "description": "Number of guests, as a numeral string (e.g. \"2\").",
                    },
                    "room_type": {
                        "type": "string",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "guests": {"type": "string", "description": "Number of guests, as a numeral string (e.g. \"2\")."},
...
def _coerce_guests(value) -> int:
    """guests is declared as a string in the tool schema (some models reliably
    emit a quoted digit string, e.g. "3", for an integer-typed parameter, which
    strict tool-schema validation rejects). Falls back to 1 if unparseable."""
    try:
...
def run_tool(name: str, args: dict) -> dict:
    ...
    if name == "check_availability":
        guests = _coerce_guests(args.get("guests"))
